...
CREATE TABLE staging_transactions (
  ...
  oldbalanceOrg DECIMAL(15, 2) NOT NULL DEFAULT 0,
  newbalanceOrig DECIMAL(15, 2) NOT NULL DEFAULT 0,
  nameDest VARCHAR(255) NOT NULL,
  oldbalanceDest DECIMAL(15, 2) NOT NULL DEFAULT 0,
  newbalanceDest DECIMAL(15, 2) NOT NULL DEFAULT 0,
